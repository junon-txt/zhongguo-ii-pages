...
```zii
[15:34] Robinson: para hacer amigos se ingresa el comando '/friend+username'
[15:34] Robinson: también se puede hacer click en un botón lindo y con colores
[15:34] Robinson: en la parte inferior derecha de la pantalla
[15:35] Robinson: la opción que más te gustela opción que más te guste
```
...
```zii
[15:35] Robinson: tenés alguna duda?
[15:35] Won_Lei: no
```
...
Si la situación se sostenía, iba a tener que comprar un celular uno nuevo. Específicamente uno que no sea de origen chino.
...
```zii
[17:38] Won_Lei: Nosotros enfrentemos
[17:38] Robinson: Podemos deconectarnos
[17:38] Robinson: Es tocar un botón
[17:39] Robinson: Nos ahorramos el problema
[17:40] Won_Lei: Al volvernos a conectar, siguen en este lugar. 
[17:40] Won_Lei: Aunque la espera alcance como para que se hayan ido, es posible que otros jugadores esperen.
```
...
```zii
[17:40] Robinson: Entraste en alguna city Won Lei?
[17:40] Won_Lei: No entré a ninguna ciudad.
```
...
```zii
[17:40] Won_Lei: Al final, morimos igual.
```
...
```zii
[17:42] Won_Lei: Ya lo dije: miedo a morir no tengo 
```
...
Acaso fue esta combinación arbitraria de variables sin importancia que ahora cobraban sentido para mí y solo para mí o fue Won Lei mismo y no sus palabras ni su coraje ni su resolución, pero sin importar la razón dejé de esquivar los golpes de los osos. No dejé de lanzar los míos primero al aire, al ficticio aire, y luego a los osos pardos. Al único oso pardo programado. A las copias del mismo. O a todos los osos pardos como abstracción.
...
Lo único importante de todo aquello eran los mensajes de mi madre:
